    ...
    <div class="row">
        <div class="form-three widget-shadow">
            ...
            <form name="category" action="{{ url('/admin/config') }}" method="post" class="form-horizontal">
                ...
                <div class="form-group">
                    <label for="focusedinput" class="col-sm-2 control-label">Giảm giá cho khách hàng cũ %</label>
                    <div class="col-sm-8">
                        <input type="text" name="customer_discount" class="form-control1" id="focusedinput" value="{{ $configs['customer_discount'] }}" placeholder="Default Input">
                    </div>
                </div>
