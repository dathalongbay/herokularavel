...
Route::prefix('admin')->group(function() {
    ...
    /**
     *url: getdata-line/year
     * lấy dữ liệu của biểu đồ đương
     */
    Route::get('getdata-line/{year}', 'AdminController@getDataLine');
    ...
    Route::get('shop/order/{id}/printView', 'Admin\ShopOrderController@printView');
    Route::get('shop/order/{id}/printInvoice', 'Admin\ShopOrderController@printInvoice');
